...

  	{
...

  	   {
  	      ...
  	      alert('<?php echo LANG_EVENT_JAVASCRIPT_VALID_DATE;?>');
...

  	   {
  	      ...
  	      alert('<?php echo LANG_EVENT_JAVASCRIPT_INSERT_DESCR;?>');
...

  	   {
  	      ...
  	      alert('<?php echo LANG_EVENT_JAVASCRIPT_INSERT_PLACE;?>');
  	   ...
  	   //   alert('<?php echo LANG_EVENT_JAVASCRIPT_INSERT_TIME;?>');
