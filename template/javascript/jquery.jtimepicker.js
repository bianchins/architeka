...
(function($) {
    $.fn.extend({
        ...
        jtimepicker: function(options) {
            ...
            var defaults = {
                clockIcon: 'template/javascript/images/icon_clock_2.gif',
            ...
            return this.each(function() {
                ...
                html += '<img src="' + o.clockIcon + '" class="clock" style="border:0px;margin:1px;padding:1px;"/>';
                ...
                $.each(sliderData, function(i, item) {
				 ...
				 var pos = $('#timepickerDate2').position();
				 $("#sliderWrap").css( { "left": pos.left  + "px", "top":(pos.top + 30) + "px" } );
